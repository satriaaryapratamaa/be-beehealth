...
// (Opsional) Jika kamu pakai package, import di sini
// import { bmr, tdee } from 'fitness-calculator';
...
function calculateTDEE(bmr) {
  const activityLevel = 1.375; // Contoh: Olahraga ringan 1-3x/minggu
